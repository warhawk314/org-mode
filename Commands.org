...
-g*.H a.*hack    - search for the word "time" in all .cljs files (*seems to work !*)
-C5 foo          - search for "foo" but show 5 lines of context before and after the match (*seems to work !*)
